...
public class App {
    public static void main(String[] args) {
        ...
        Set<Studerende> studerendeSet = new TreeSet<>(new StuderendeComparator());
        studerendeSet.addAll(skole.getStuderendeList());
//        studerendeSet.removeIf(s -> s.getNavn().equals("Gustav"));
        System.out.println(studerendeSet);
    }
}
